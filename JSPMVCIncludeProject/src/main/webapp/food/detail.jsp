   		...
   		<div class="flexslider carousel basiccarousel btmspace-80">
    		<ul class="slides">
    			<c:forTokens var="image" items="${vo.images }" delims=",">
        			<li>
          				<figure>
          					<img class="radius-10 btmspace-10" src="http://www.menupan.com${image }" style="width:320px; height:185px;">
          				</figure>
        			</li>
       		 	</c:forTokens>
      		</ul>
        ...
        <div class="option">
            <div>
                <form onsubmit="searchPlaces(); return false;">
                    키워드 : <input type="text" value="${addr }" id="keyword" size="15" readonly> 
                </form>
            </div>
        </div>
        <hr>
