...
<%
	...
	FoodVO vo = dao.getFoodDetail(Integer.parseInt(fno), 1);
%>  
<!DOCTYPE html>
<html>
<head>
...
<script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=443acdfb0df827f13186e681c2acda8c&libraries=services"></script>
...
<body>
	<div class="container">
			...
			<table class="table">
				<tr>
					<td width=30% class="text-center" rowspan="8">
						<img src="<%= vo.getPoster() %>" style="width: 200px; height: 170x; margin-top: 100px;">
					</td>
					<td colspan="2">
		...
		<div class="row">
	<div id="map" style="width:100%;height:350px; margin-bottom: 70px;"></div>
	</div>
	<script>
