    ...
    <section class="archive-area section_padding_80">
        <div class="container">
            <div class="row" style="width:800px; margin: 0px auto">
            	<form method="post" action="../member/join_ok.do" name="frm" id="frm"><!-- name 속성 값들이 다 넘어감 -->
            	<table class="table">
					<tr>
					...
					<tr>
						...
						<td width=85%>
							<input type="text" name="post" id="post" size="10" class="form-control-sm" readonly>
							<input type="button" value="우편번호 검색" class="btn-sm btn-danger" id="postBtn">
						</td>
					</tr>
					<tr>
						<th width=15% class="text-center" style="color:gray">주소</th>
						<td width=85%>
							<input type="text" name="addr1" id="addr1"size="55" class="form-control-sm" readonly>
						</td>
					</tr>
					<tr>
