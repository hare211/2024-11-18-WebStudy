            ...
            <div class="row" style="width:800px; margin: 0px auto">
            	...
            	<table class="table">
            		<tr>
            			...
            			<td width="85%">
            				<input type="text" name="name" id="name" size="20" class="form-control-sm" value="${vo.name }">
            		...
            		<tr>
            			...
            			<td width="85%">
            				<input type="text" name="subject" id="subject" size="50" class="form-control-sm" value="${vo.subject }">
            			</td>
            		</tr>
            		<tr>
            			<th class="text-center" width="15%">내용</th>
            			<td width="85%">
            				<textarea rows="10" cols="52" name="content" value="${vo.content }"></textarea>
            			</td>
            		</tr>
            		<tr>
            			<th class="text-center" width="15%">비밀번호</th>
            			<td width="85%">
            				<input type="text" name="pwd" id="pwd" size="20" class="form-control-sm">
            			</td>
            		</tr>
            		<tr>
